                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" method="post">
                                    <input type="hidden" name="idProduct" value="${listEdit.getIdProduct()}"/>
                                    <div class="form-group row">
                                        <label class="col-md-2 control-label">Title</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="title" value="${listEdit.getTitle()}"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 control-label" for="example-password">Price</label>
                                        <div class="col-md-10">
                                            <input type="number" id="example-password" class="form-control" name="price" value="${listEdit.getPrice()}"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control" name="quantity" value="${listEdit.getQuantity()}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="image" value="${listEdit.getImage()}"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 control-label">Description</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="description" value="${listEdit.getDescription()}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="idCategory">
                                                <c:forEach items="${listC}" var="listC">
                                                    <c:choose>
                                                        <c:when test="${listC.getIdCategory() == listEdit.getIdCategory()}">
                                                            <option value="${listC.getIdCategory()}" selected> ${listC.getNameCategory()}</option>
                                                        </c:when>
